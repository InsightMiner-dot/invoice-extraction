...
with tab_analytics:
    ...
    if df_audit.empty:
        ...
        # Determine specific errors for KPIs and Charts
...
with tab_system:
    ...
    if df_audit.empty:
        ...
        # Calculate Pass/Fail Percentages (Overall System Review)
        ...
        # Calculate Math Accuracy (Strictly on Variance, ignoring missing routing)
